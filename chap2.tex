...
\begin{figure}
    \centering
    \includegraphics[width=14cm]{Thesis_ICD/figure1/UAVs_types.jpg}
...
\begin{figure}
    \centering
    \includegraphics[width=10cm]{Thesis_ICD/figure1/uav1.jpg}
...
\begin{figure}
    \centering
    \includegraphics[width=10cm]{Thesis_ICD/figure1/uav2.jpg}
...
\begin{figure}
    \centering
    \includegraphics[width=10cm]{Thesis_ICD/figure1/uav3.jpg}
...
\begin{figure}[htbp]
    \centering    \includegraphics[width=0.6\linewidth]{Thesis_ICD/figure2/rbfnn_architecture.jpg}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.8\linewidth]{Thesis_ICD/figure2/fls_architecture.jpg}
...
\begin{figure}[h!]
\centering
\includegraphics[width=14cm]{Thesis_ICD/figure2/fixed time test.pdf}
